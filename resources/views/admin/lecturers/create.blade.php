...
@section('content')
    <form action="/admin/lecturers" method="POST" enctype="multipart/form-data" id="lecturerForm">
        @csrf
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <label>Title</label>
                        <input type="text" name="title" value="{{ old('title') }}" class="form-control" placeholder="Dr., MSc., Eng.">
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        <label>Position</label>
                        <input type="text" name="position" value="{{ old('position') }}" class="form-control" placeholder="Head of Department, Lecturer…">
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <textarea name="research_interests" class="form-control" rows="3" placeholder="e.g. IoT, Machine Learning, Embedded Systems">{{ old('research_interests') }}</textarea>
            </div>
